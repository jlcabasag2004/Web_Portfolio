...
// Cisco Certificates paths - these files should be in public folder for proper access
// For now, we'll reference them from src using a different approach
                ...
                {displayedCertificates.map((certificate, index) => (
                  ...
                  >
                    <Certificate 
                      ...
                      FileType={certificate.FileType || 'image'}
